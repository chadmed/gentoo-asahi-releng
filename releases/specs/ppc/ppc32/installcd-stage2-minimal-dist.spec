...
livecd/iso: /var/tmp/catalyst/builds/23.0-default/install-powerpc-minimal-dist-@TIMESTAMP@.iso
...
boot/kernel/gentoo/config: @REPO_DIR@/releases/kconfig/powerpc/dist-ppc-livecd.config
